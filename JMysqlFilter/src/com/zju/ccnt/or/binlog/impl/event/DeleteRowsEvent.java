...
/**
 * Used for row-based binary logging. This event logs deletions of rows in a
 * single table.
 * 
...
public final class DeleteRowsEvent extends AbstractRowEvent {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
				.append("header", header).append("tableId", tableId)
				.append("reserved", reserved)
				.append("columnCount", columnCount)
				.append("usedColumns", usedColumns).append("rows", rows)
				.toString();
	}
