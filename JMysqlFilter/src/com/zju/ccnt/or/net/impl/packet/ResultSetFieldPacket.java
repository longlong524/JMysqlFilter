 ...
 */
public class ResultSetFieldPacket extends RawPacket {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
				.append("catalog", catalog).append("db", db)
				.append("table", table).append("orginalTable", orginalTable)
				.append("column", column)
				.append("originalColumn", originalColumn)
				.append("fixed12", fixed12).append("charset", charset)
	 ...
	 * 
	 */
	public static ResultSetFieldPacket valueOf(AbstractPacket packet)
			throws IOException {
