 ...
 */
public class GreetingPacket extends RawPacket {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
				...
				.append("threadId", threadId).append("scramble1", scramble1)
	 ...
	 * 
	 */
	public static GreetingPacket valueOf(AbstractPacket packet)
			throws IOException {
